...
/**
 * This is the model class for table "spares_lookup".
 *
 * The followings are the available columns in table 'spares_lookup':
 * @property integer $id
 * @property string $url
 ...
 */
class SparesLookup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return SparesLookup the static model class
	 */
