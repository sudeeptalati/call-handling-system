...
{
	echo "<p><span style='color:red'>Sorry the module cannot be uninstalled as it is in Used and enabled. Please Disable the module first and then try again</span><p>";
