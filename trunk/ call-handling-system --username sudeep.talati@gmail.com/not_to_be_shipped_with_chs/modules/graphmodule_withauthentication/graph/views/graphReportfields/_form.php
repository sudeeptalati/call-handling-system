...
{	
	...
	if (uplifts_relation.indexOf(relation_1.value) > -1)
	{
		...
		$.ajax({
		type: "GET",
		url: "index.php?r=graph/graphreportfields/GetRelationsAndFieldsListByModelName",
...
function relation_changed_dynamic(dynamic_relation_select_object)
{
	...
	$.ajax({
		type: "GET",
		url: "index.php?r=graph/graphreportfields/CheckFieldOrRelationByModelNameAndValue",
